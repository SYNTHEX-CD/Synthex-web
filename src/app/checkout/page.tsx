...
export const metadata: Metadata = {
  title: "Paiement - SYNTHEX",
  description: "Finalisez votre demande en toute sécurité",
};
...
export default async function CheckoutPage({ searchParams }: Props) {
  ...
  if (!urlPriceId && !transactionId) {
    return <div className="grid place-items-center p-8 text-xl">Identifiant de tarif manquant</div>;
  }
